...
<head>
    ...
    <?php if (!empty($jsonLd)): ?><script type="application/ld+json"><?= is_array($jsonLd) ? json_encode($jsonLd, JSON_UNESCAPED_SLASHES) : $jsonLd ?></script><?php endif; ?>
    <style>
...
<nav class="blog-nav" role="navigation">
    <div class="blog-nav-inner">
        ...
        <div class="blog-nav-links">
            ...
            <a href="<?= h(path('blog.php')) ?>" class="active"><?= function_exists('__') ? h(__('blog_nav_blog')) : 'Blog' ?></a>
